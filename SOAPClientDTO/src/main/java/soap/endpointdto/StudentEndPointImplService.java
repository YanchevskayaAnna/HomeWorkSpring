 ...
 * 
 */
@WebServiceClient(name = "StudentEndPointImplService", targetNamespace = "http://endpointDTO.soap/", wsdlLocation = "http://192.168.0.100:9999/soap/student?wsdl")
    ...
    extends Service
{
    ...
    private final static QName STUDENTENDPOINTIMPLSERVICE_QNAME = new QName("http://endpointDTO.soap/", "StudentEndPointImplService");
    ...
    public StudentEndPoint getStudentEndPointImplPort() {
        return super.getPort(new QName("http://endpointDTO.soap/", "StudentEndPointImplPort"), StudentEndPoint.class);
    }
    ...
    public StudentEndPoint getStudentEndPointImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://endpointDTO.soap/", "StudentEndPointImplPort"), StudentEndPoint.class, features);
    }
